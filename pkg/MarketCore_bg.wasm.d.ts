...
export function __wbg_marketwrapper_free(a: number): void;
export function marketwrapper_new(): number;
export function marketwrapper_test(a: number, b: number): void;
export function marketwrapper_test_serialization(a: number, b: number, c: number, d: number): void;
export function marketwrapper_buy(a: number, b: number, c: number, d: number): void;
